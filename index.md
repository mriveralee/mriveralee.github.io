...
<div class="post" style="margin-top: 44px;">
  <article class="post-content">
    ...
    <br/>
    <br/>
    My primary research interests are at the intersection of human-computer interaction (HCI) and digital fabrication. I develop hardware, software and material techniques that extend the capabilities of digital fabrication technology like 3D printing, and explore how they can be used for functional and creative purposes. My dissertation introduces digital fabrication techniques for soft materials like textiles in 3D printing processes to broaden the design space for creating personalized and interactive objects.
    <br/>
    <br/>
