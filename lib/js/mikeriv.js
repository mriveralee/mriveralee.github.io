...
MIKERIV.ABOUT = {
  ...
  desc: [
    'I study <em>Digital Media Design</em> and <em>Computer Graphics & Game Technology</em> at the <a href="http://cg.cis.upenn.edu/index.html" target="_blank">University of Pennsylvania</a>.',
    ' In my summers, I\'ve worked on awesome mobile applications at <a href="http://www.linkedin.com" target="_blank">LinkedIn</a> and <a href="http://facebook.com/" target="_blank">Facebook</a>.',
    ' My research interests concern building adaptive interfaces and devices that make our communication through and with technology more beneficial. More specifically, I want to use technology to enhance our ability to learn about each other, our environments, and music.',
    ' If you\'d like to chat or grab coffee, <a href="mailto:mrivera.lee@gmail.com?Subject=Hello!">let\'s get in touch</a>!',
  ],
  resume: '<a class="about-icon-link" href="downloads/Rivera_Michael_Resume.pdf" alt="Resume" title="Resume" target="_blank"><i class="fa fa-file-text-o"></i></a>',
  ...
  contact: [
    ...
    { title: 'Resume',
      url: 'downloads/Rivera_Michael_Resume.pdf',
